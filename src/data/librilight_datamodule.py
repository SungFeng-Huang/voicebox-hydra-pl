...
class LibriLightDataModule(LightningDataModule):
    """`LightningDataModule` for the LibriLight dataset.
    ...
    def __init__(
        self,
        data_dir: str = "/datasets/LibriLight/",
    ...
    def prepare_data(self) -> None:
        ...
        for subset in ['small', 'medium', 'large', 'dev', 'test_clean', 'test_other', 'test_clean_large', 'test_other_large']:
            if not os.path.exists(f"data/LibriHeavy/libriheavy_cuts_${subset}.jsonl.gz"):
                ...
                os.system(f"log \"Skipping download, {subset} subset exists.\"")
